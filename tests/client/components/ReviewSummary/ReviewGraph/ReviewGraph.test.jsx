...
describe('ReviewGraph Component', () => {
  ...
  it('should set opacity prop of GraphLink component to 1 by default', () => {
    const reviewSummary = [
      {
        rating_5: 5,
        rating_4: 4,
    ...
    const wrapper = shallow(<ReviewGraph reviewSummary={reviewSummary} />);
    expect(wrapper.find(GraphLink).at(0).props().opacity).toBe(1);
  });

  it('should set opacity prop of GraphLink component to 0.3 when hovering over the ReviewGraph component', () => {
    const reviewSummary = [
      {
        rating_5: 5,
        rating_4: 4,
    ...
    const wrapper = shallow(<ReviewGraph reviewSummary={reviewSummary} />);
    wrapper.invoke('onMouseOver')();
    expect(wrapper.find(GraphLink).at(0).props().opacity).toBe(0.3);
    expect(wrapper.find(GraphLink).at(1).props().opacity).toBe(0.3);
    expect(wrapper.find(GraphLink).at(2).props().opacity).toBe(0.3);
    expect(wrapper.find(GraphLink).at(3).props().opacity).toBe(0.3);
    expect(wrapper.find(GraphLink).at(4).props().opacity).toBe(0.3);
  });

  it('should set opacity prop of GraphLink component back to 1 when mouse cursor leaves the component', () => {
    const reviewSummary = [
      {
        rating_5: 5,
        rating_4: 4,
    ...
    expect(wrapper.find(GraphLink).at(0).props().opacity).toBe(1);
    expect(wrapper.find(GraphLink).at(1).props().opacity).toBe(1);
    expect(wrapper.find(GraphLink).at(2).props().opacity).toBe(1);
    expect(wrapper.find(GraphLink).at(3).props().opacity).toBe(1);
    expect(wrapper.find(GraphLink).at(4).props().opacity).toBe(1);
  });
});
